...
\documentTitle{
  \begin{tabular}{@{}l l@{}}
    ...
    \begin{tabular}[b]{@{}@{\hspace{2mm}}l@{}}
      \textbf{Reinier Kip} \\
      Freelance Software Engineer \& Architect
    \end{tabular}
  \end{tabular}
}{
  \href{tel:027 8181 957}{\raisebox{0\height} \faPhone\ 027 8181 957}
  ~ | ~
  \href{mailto:hello@reinier.nz}{\raisebox{0\height} \faEnvelope\ hello@reinier.nz}
  ~ | ~
  \href{https://linkedin.com/in/rjkip}{\raisebox{0\height} \faLinkedin\ linkedin.com/in/rjkip}
  ~ | ~
  {\raisebox{0\height} \faMapPin\ Christchurch, New Zealand}
}
